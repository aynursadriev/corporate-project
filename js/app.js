(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".mainpage-houses__slider-first")) new swiper_core_Swiper(".mainpage-houses__slider-first", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".mainpage-houses__slider-second")) new swiper_core_Swiper(".mainpage-houses__slider-second", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".mainpage-product__thumbs")) var swiperThumbs = new swiper_core_Swiper(".mainpage-product__thumbs", {
                modules: [],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".mainpage-product__slider")) new swiper_core_Swiper(".mainpage-product__slider", {
        ...
        if (catalogTabs) {
            ...
            const nextButton = catalogTabs.querySelector(".catalog-tabs__next");
            const titleButtons = catalogTabs.querySelectorAll(".catalog-tabs__title");
            prevButton.addEventListener("click", (function() {
                const activeTitleButton = catalogTabs.querySelector(".catalog-tabs__title._tab-active");
                const prevTitleButton = activeTitleButton.previousElementSibling;
                if (prevTitleButton) prevTitleButton.click();
            }));
            nextButton.addEventListener("click", (function() {
                const activeTitleButton = catalogTabs.querySelector(".catalog-tabs__title._tab-active");
                const nextTitleButton = activeTitleButton.nextElementSibling;
                if (nextTitleButton) nextTitleButton.click();
            }));
            titleButtons.forEach((function(titleButton) {
                titleButton.addEventListener("click", (function() {}));
            }));
        }
        if (document.getElementById("catalog-file")) document.getElementById("catalog-file").addEventListener("change", (function(event) {
